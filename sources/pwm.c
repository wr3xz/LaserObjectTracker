...
main(int argc, char **argv)
{
    ...
    print_channel(channel);
		...
		add_channel_pulse(channel, gpio, 0, 1760);
		add_channel_pulse(channel, gpio2, 0, 1940);
		...
		add_channel_pulse(channel, gpio, 0, 1900);
		usleep(demo_timeout);
		clear_channel_gpio(0, 17);
		
		
		add_channel_pulse(channel, gpio, 0, 1840);
		usleep(demo_timeout);
		clear_channel_gpio(0, 17);

		add_channel_pulse(channel, gpio, 0, 1800);
		usleep(demo_timeout);    
		clear_channel_gpio(0, 17);
